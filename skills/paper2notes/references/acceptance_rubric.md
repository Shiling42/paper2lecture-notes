...
3. **Score + collect blockers.** A referee agent reads the built PDF and scores all 8
   ...
   dry summary instead of a physical picture, missing reading contract, page overrun) are
   filed as blockers scored under dimensions 1 and 7 — never as a seventh gate.
